...
const char* DEVICE_ID     = "ESP32-DDOS-01";
...
String generatePayload() {
  ...
  // Send simple IoT data (same payload as normal device, just faster rate)
...
void loop() {
  ...
  // DDOS DEVICE DELAY: Send data very fast (10 requests per second)
  delay(100); 
}
